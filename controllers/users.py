...
#cred = credentials.Certificate("secrets/libros-proyecto.json")
#firebase_admin.initialize_app(cred)

#Esto es lo nuevoooooo
def initialize_firebase():
    ...
    try:
        ...
        if firebase_creds_base64:
            ...
            firebase_admin.initialize_app(cred)
            logger.info("Firebase inicialized with enviroment variable credentials")
        ...
        raise HTTPException(status_code=500, detail=f"Firebase configuratio error: {str(e)}")
